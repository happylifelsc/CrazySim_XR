/* This file is automatically generated by /home/cpsl/CrazySim/crazyflie-firmware/sitl_make/../tools/make/versionTemplate.py!
...
const char * V_SLOCAL_REVISION="3";
const char * V_SREVISION="6a4d2d006ba3";
const char * V_STAG="v1.2-alpha +3";
const char * V_BRANCH="HEAD";
const bool V_MODIFIED=false;
const bool V_PRODUCTION_RELEASE=false;

/* Version recoverable from the ground */
const uint32_t V_REVISION_0=0x6a4d2d00;
const uint16_t V_REVISION_1=0x6ba3;
